...
public class LancamentoController {
	...
	public ResponseEntity<Optional<Lancamento>> buscarPeloCodigo(@PathVariable Long codigo) {
		...
		return lancamento.isPresent() ? new ResponseEntity<>(lancamento,HttpStatus.OK) : ResponseEntity.notFound().build();
	}
	
	@PostMapping
	public ResponseEntity<Lancamento> criar(@Valid @RequestBody Lancamento lancamento, HttpServletResponse response) {
		
		Lancamento lancamentoSalva = lancamentoService.savarLancamento(lancamento);
